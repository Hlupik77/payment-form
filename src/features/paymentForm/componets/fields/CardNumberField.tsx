...
export const CardNumberField = ({ register, disabled }: Props) => {
  return (
    <div className="col-span-1 md:col-span-2 h-[84px] w-[417px] mx-auto">
      <div className="grid grid-cols-[auto,1fr] items-center gap-x-3 gap-y-1">
        <label htmlFor="cardNumber" className="text-[14px] leading-[18px] font-normal text-grey-800 whitespace-nowrap">
          Номер карты
        </label>
        <input
          id="cardNumber"
